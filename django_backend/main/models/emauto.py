...
class AppElsiCollegeDtls(models.Model):
    id = models.IntegerField(blank=True, null=False, primary_key=True,unique=True)
...
class AppWorkshopParticipants(models.Model):
...
class AppWorkshopDtls(models.Model):
    id = models.IntegerField(blank=True, null=False,primary_key=True)
    region_id = models.IntegerField(blank=True, null=True)
    clg_id = models.IntegerField(blank=True, null=True)
...
class AppTbtCollegeDtls(models.Model):
    id = models.IntegerField(blank=True, null=False,primary_key=True)
