# Generated by Django 2.2.12 on 2020-06-12 16:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('willingness_or_unavailability', models.CharField(blank=True, default='None', max_length=20, null=True)),
                ('reason', models.CharField(blank=True, max_length=50, null=True)),
                ('eYRC', models.CharField(default='0', max_length=20)),
                ('eYIC', models.CharField(default='0', max_length=20)),
                ('eYRDC', models.CharField(default='0', max_length=20)),
                ('eLSI', models.CharField(default='0', max_length=20)),
                ('web', models.CharField(default='0', max_length=20)),
                ('course_or_other_eyantra_work', models.CharField(default='0', max_length=20)),
                ('personal_or_any_other', models.CharField(default='0', max_length=20)),
